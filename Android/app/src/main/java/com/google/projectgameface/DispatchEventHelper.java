...
public class DispatchEventHelper {
  ...
  public static void checkAndDispatchEvent(
    ...
    switch (event) {
      ...
      case IME_TOGGLE_DICTATION:
        sendImeCommand(parentService, VoiceAccessInputMethodService.COMMAND_TOGGLE_DICTATION);
        break;

      case IME_SWITCH_MODE:
        sendImeCommand(parentService, VoiceAccessInputMethodService.COMMAND_SWITCH_MODE);
        break;

      case IME_TOGGLE_SIZE:
        sendImeCommand(parentService, VoiceAccessInputMethodService.COMMAND_TOGGLE_SIZE);
        break;

      case IME_MOVE_TO_POINTER:
        sendImeCommand(parentService, VoiceAccessInputMethodService.COMMAND_MOVE_TO_POINTER);
        break;
  ...
  private static void sendImeCommand(
      CursorAccessibilityService parentService,
      String command) {
    android.content.Intent intent = new android.content.Intent(
        VoiceAccessInputMethodService.ACTION_IME_CONTROL);
    intent.putExtra(VoiceAccessInputMethodService.EXTRA_IME_COMMAND, command);
    parentService.sendBroadcast(intent);
  }
}
