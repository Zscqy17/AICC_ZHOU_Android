...
public class BlendshapeEventTriggerConfig {
  ...
  public static final HashMap<EventType, String> BEATIFY_EVENT_TYPE_NAME = new HashMap<EventType, String>() {{
    ...
    put(EventType.IME_TOGGLE_DICTATION, "AICC keyboard start / stop");
    put(EventType.IME_SWITCH_MODE, "AICC keyboard mode");
    put(EventType.IME_TOGGLE_SIZE, "AICC keyboard large keys");
    put(EventType.IME_MOVE_TO_POINTER, "Move AICC keyboard to pointer");
