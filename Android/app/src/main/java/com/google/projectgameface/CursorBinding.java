...
public class CursorBinding extends AppCompatActivity {
    ...
    TextView textDrag;
    TextView dragLinear;
    TextView textImeDictation;
    TextView imeDictationLinear;
    TextView textImeMode;
    TextView imeModeLinear;
    TextView textImeSize;
    TextView imeSizeLinear;
    TextView textImeMove;
    TextView imeMoveLinear;
    ...
    private void refreshUI()
    {
        ...
        setUpActionList(
            String.valueOf(BlendshapeEventTriggerConfig.EventType.IME_TOGGLE_DICTATION),
            textImeDictation,
            imeDictationLinear,
            (ImageView) findViewById(R.id.imeDictationIcon));

        setUpActionList(
            String.valueOf(BlendshapeEventTriggerConfig.EventType.IME_SWITCH_MODE),
            textImeMode,
            imeModeLinear,
            (ImageView) findViewById(R.id.imeModeIcon));

        setUpActionList(
            String.valueOf(BlendshapeEventTriggerConfig.EventType.IME_TOGGLE_SIZE),
            textImeSize,
            imeSizeLinear,
            (ImageView) findViewById(R.id.imeSizeIcon));

        setUpActionList(
            String.valueOf(BlendshapeEventTriggerConfig.EventType.IME_MOVE_TO_POINTER),
            textImeMove,
            imeMoveLinear,
            (ImageView) findViewById(R.id.imeMoveIcon));
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textImeDictation = findViewById(R.id.imeDictationBinding);
        imeDictationLinear = findViewById(R.id.imeDictationLinear);
        textImeMode = findViewById(R.id.imeModeBinding);
        imeModeLinear = findViewById(R.id.imeModeLinear);
        textImeSize = findViewById(R.id.imeSizeBinding);
        imeSizeLinear = findViewById(R.id.imeSizeLinear);
        textImeMove = findViewById(R.id.imeMoveBinding);
        imeMoveLinear = findViewById(R.id.imeMoveLinear);
            ...
            findViewById(id)
                .setOnClickListener(
                    v -> {
                        ...
                        } else if (v.getId() == R.id.imeDictationLayout) {
                            intent.putExtra("eventType", BlendshapeEventTriggerConfig.EventType.IME_TOGGLE_DICTATION);
                        } else if (v.getId() == R.id.imeModeLayout) {
                            intent.putExtra("eventType", BlendshapeEventTriggerConfig.EventType.IME_SWITCH_MODE);
                        } else if (v.getId() == R.id.imeSizeLayout) {
                            intent.putExtra("eventType", BlendshapeEventTriggerConfig.EventType.IME_TOGGLE_SIZE);
                        } else if (v.getId() == R.id.imeMoveLayout) {
                            intent.putExtra("eventType", BlendshapeEventTriggerConfig.EventType.IME_MOVE_TO_POINTER);
                        }
