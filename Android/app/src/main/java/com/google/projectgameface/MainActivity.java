...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.voiceKeyboardRow).setOnClickListener(v -> {
        ...
        if(isFirstLaunch()){
            ...
            BlendshapeEventTriggerConfig.writeBindingConfig(this, BlendshapeEventTriggerConfig.Blendshape.MOUTH_RIGHT,
                ...
                BlendshapeEventTriggerConfig.writeBindingConfig(this, BlendshapeEventTriggerConfig.Blendshape.RAISE_LEFT_EYEBROW,
                    BlendshapeEventTriggerConfig.EventType.IME_TOGGLE_DICTATION, 20);
                BlendshapeEventTriggerConfig.writeBindingConfig(this, BlendshapeEventTriggerConfig.Blendshape.RAISE_RIGHT_EYEBROW,
                    BlendshapeEventTriggerConfig.EventType.IME_SWITCH_MODE, 20);
                BlendshapeEventTriggerConfig.writeBindingConfig(this, BlendshapeEventTriggerConfig.Blendshape.LOWER_LEFT_EYEBROW,
                    BlendshapeEventTriggerConfig.EventType.IME_TOGGLE_SIZE, 20);
                BlendshapeEventTriggerConfig.writeBindingConfig(this, BlendshapeEventTriggerConfig.Blendshape.LOWER_RIGHT_EYEBROW,
                    BlendshapeEventTriggerConfig.EventType.IME_MOVE_TO_POINTER, 20);
